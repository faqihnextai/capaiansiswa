...
use App\Http\Controllers\StoryController; // Pastikan ini sudah ada
...
// Perubahan di sini: tambahkan parameter opsional {class?}
Route::get('/materi/{class?}', [AdminController::class, 'showPublicMaterials'])->name('public.materi');

// Route untuk halaman Tugas (daftar tugas)
...
// Route untuk halaman Story Publik
Route::get('/stories', [StoryController::class, 'showPublicStoriesPage'])->name('public.stories');

// Route API untuk mengambil story aktif (digunakan oleh frontend)
...
Route::prefix('admin')->group(function () {
    ...
    // Rute untuk mengelola Materi & Aset
    ...
    // Rute untuk menghapus tugas (seperti yang ada di manage_submission.blade.php)
    Route::delete('/tasks/{task}', [AdminController::class, 'destroyTask'])->name('admin.tasks.destroy');

    // Rute untuk menghapus pengumpulan tugas (submission) siswa (seperti yang ada di manage_submission.blade.php)
    Route::delete('/submissions/{submission}', [AdminController::class, 'destroySubmission'])->name('admin.submissions.destroy');


    // Rute untuk mengelola Story di sisi Admin (sudah ada)
